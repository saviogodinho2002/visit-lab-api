...
function edit(application){
    ...
    form.get(route("applications.edit",application))
}
function destroy(application){

    form.application = application
    form.delete(route("applications.destroy",application))
}
                    ...
                    <div class="flex flex-wrap justify-around space-y-1">
                        ...
                        <div v-for="application in applications" class=" max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <div class="flex justify-around mt-3">
                                ...
                                <SecondaryButton @click="edit(application)">
                                    Editar
                                </SecondaryButton>
                                <DangerButton @click="destroy(application)">
                                    Excluir
                                </DangerButton>
                            </div>
                            <button @click="showUUID(application)" class="ml-3 mt-3 w-100 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Ver chave
